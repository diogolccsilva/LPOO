...
public class RangedEnemy extends Enemy {
    ...
    public RangedEnemy(Game game, int x, int y, int health, int resistance, int damage) {
        ...
        shotRange = new Rectangle( rect.x + rect.width / 2, rect.y, range, rect.height);
        attack_time = 0.3f;
    }
        ...
        switch( state ) {
            ...
            case ATTACK:
                if( stateTime >= stats.getAttSpeed() ) {
                    ...
                    Projectile projectile = new Projectile(game, rect.x + rect.width / 2, rect.y + 15, 10, 10, 5, range, false);
